...
TOKEN = '7980522216:AAGGt9a_LnJoTEHksrx3og5Mc2R1zjYAjMc'  # Replace with your actual bot token
...
# Check if the number of running attacks is at the limit
    ...
    try:
        ...
        logging.info(f"Attack started by {user_name}: ./shadow {target_ip} {target_port} {default_duration} 50")
